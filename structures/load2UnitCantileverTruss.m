...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% This function loads a 2 unit cantilever truss structure.
%
% Outputs:
% --------
...
function [params] = load2UnitCantileverTruss()
links = [1, 4;
         1, 6;
         2, 3;
         3, 4;
...
idxCtrlU = controlDisplacement(6, 2, identity, nNodes, nDof, nFree);
deltaU = 1;
