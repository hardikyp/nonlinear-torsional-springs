...
% incr (int): current increment number
%
% Outputs:
% --------
...
% axialF (array): Updated history of axial force in bar each member 
%                (nBar, maxIncr + 1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [kSystem, intF, axialF] = globalStiffness(coords, coordsPrev, ...
    ...
    for el = 1:nBars
        ...
        [axialForce, intFBar] = barForceRec(coords, coordsPrev, ...
                                            ...
                                            reshapeIdx, axialF(el, incr + 1));

        axialF(el, incr + 1) = axialF(el, incr + 1) + axialForce;
        
        kLocal = barStiffness(E(el), A(el), L(el));
        kGeom = geomStiffness(axialF(el, incr + 1), L(el));
    ...
    % encapsulate internal nodal force from current iteration for output
